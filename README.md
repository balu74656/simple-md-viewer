...
Po instalaci si aplikaci [nastav jako výchozí pro `.md`](#nastavení-jako-výchozí-aplikace-pro-md).
...
1. Pravý klik na libovolný `.md` soubor → **Otevřít v programu** → **Zvolit jinou aplikaci**
2. Vyber **MD Viewer** a zaškrtni **Vždy používat tuto aplikaci**.
